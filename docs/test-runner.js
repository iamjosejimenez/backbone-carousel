...
var ComponentError = function (_Error) {
  _inherits(ComponentError, _Error);

  function ComponentError(message) {
    _classCallCheck(this, ComponentError);

    var _this = _possibleConstructorReturn(this, (ComponentError.__proto__ || Object.getPrototypeOf(ComponentError)).call(this, { message: message }));
...
var Component = function (_LayoutManager) {
  _inherits(Component, _LayoutManager);

  function Component(instanceProperties, classProperties) {
    _classCallCheck(this, Component);

    // Attach the dataset.
    var _this2 = _possibleConstructorReturn(this, (Component.__proto__ || Object.getPrototypeOf(Component)).call(this, instanceProperties, classProperties));

    _this2.dataset = _this2.$el.data();

    // Activate new components found after rendering.
    _this2.listenTo(_this2, 'afterRender', function () {
  ...
  _createClass(Component, [{
    key: 'fetchTemplate',
    value: function fetchTemplate(template) {
      return template;
    }
    ...
    key: 'register',
    value: function register(identifier, ctor) {
    ...
    key: 'unregister',
    value: function unregister(identifier) {
      delete components[identifier];
    }
  }, {
    key: 'activate',
    value: function activate($el, instances) {
      var Ctor = this;

      // Convert all attributes on the Element into View properties.
      var attrs = _underscore2.default.reduce($el[0].attributes, function (attrs, attr) {
        var name = attr.name;
    ...
    key: 'activateAll',
    value: function activateAll(component) {
      var el = component ? component.el : document.body;

      _underscore2.default.each(components, function (current, selector) {
        (0, _jquery2.default)(el).find(selector).each(function () {
          Component.activate.call(current.ctor, (0, _jquery2.default)(this), current.instances);
        });
      });
    }
  }]);
  ...
  return Component;
}(_layoutmanager2.default);

// Activate all components on DOM ready.


(0, _jquery2.default)(Component.activateAll);
...
var Router = function (_Backbone$Router) {
  ...
  function Router() {
    ...
    return _possibleConstructorReturn(this, (Router.__proto__ || Object.getPrototypeOf(Router)).call(this, { routes: routes }));
  }
...
describe("Router", function () {
  it("is a Backbone Router", function () {
    assert(_router2.default);
    assert(new _router2.default() instanceof _backbone2.default.Router);
  });
});
