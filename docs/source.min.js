...
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{default:e}}function _classCallCheck(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}function _possibleConstructorReturn(e,t){if(!e)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return!t||"object"!=typeof t&&"function"!=typeof t?e:t}function _inherits(e,t){if("function"!=typeof t&&null!==t)throw new TypeError("Super expression must either be null or a function, not "+typeof t);e.prototype=Object.create(t&&t.prototype,{constructor:{value:e,enumerable:!1,writable:!0,configurable:!0}}),t&&(Object.setPrototypeOf?Object.setPrototypeOf(e,t):e.__proto__=t)}Object.defineProperty(exports,"__esModule",{value:!0});var _createClass=function(){function e(e,t){for(var o=0;o<t.length;o++){var n=t[o];n.enumerable=n.enumerable||!1,n.configurable=!0,"value"in n&&(n.writable=!0),Object.defineProperty(e,n.key,n)}}return function(t,o,n){return o&&e(t.prototype,o),n&&e(t,n),t}}(),_backbone=require("backbone"),_backbone2=_interopRequireDefault(_backbone),_home=require("./views/pages/home"),_home2=_interopRequireDefault(_home),_sampleComponent=require("./views/components/sample-component"),_sampleComponent2=_interopRequireDefault(_sampleComponent),routes={"":"index"},Router=function(e){function t(){return _classCallCheck(this,t),_possibleConstructorReturn(this,(t.__proto__||Object.getPrototypeOf(t)).call(this,{routes:routes}))}return _inherits(t,e),_createClass(t,[{key:"index",value:function(){new _home2.default({el:"main"}).render()}}]),t}(_backbone2.default.Router);exports.default=Router;

},{"./views/components/sample-component":5,"./views/pages/home":8,"backbone":10}],4:[function(require,module,exports){
module.exports={_partials:{},_filters:{},getPartial:function(t){if(t in this._partials)return this._partials[t];if(this._parent)return this._parent.getPartial(t);throw new Error("Missing partial "+t)},getFilter:function(t){if(t in this._filters)return this._filters[t];if(this._parent)return this._parent.getFilter(t);throw new Error("Missing filter "+t)},registerPartial:function(t,r){this._partials[t]=r,r._parent=this},registerFilter:function(t,r){this._filters[t]=r},render:function(t){function r(t){return Object.prototype.toString.call(t).slice(8,-1).toLowerCase()}function i(t){return"string"!==r(t)?t:t.replace(/["&'<>`]/g,function(t){return"&#"+t.charCodeAt(0)+";"})}try{return"<h1>Testing this out</h1>\n"}catch(t){return console.error(t),"<pre>"+i(t+t.stack)+"</pre>"}}};

},{}],5:[function(require,module,exports){
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{default:e}}Object.defineProperty(exports,"__esModule",{value:!0});var _component=require("../../component"),_component2=_interopRequireDefault(_component),_sampleComponent=require("./sample-component.html"),_sampleComponent2=_interopRequireDefault(_sampleComponent),SampleComponent=_component2.default.extend({template:_sampleComponent2.default,events:{"click h1":"handleClick"},handleClick:function(e){console.log("whatever")}});exports.default=_component2.default.register("sample-component",SampleComponent);

},{"../../component":1,"./sample-component.html":4}],6:[function(require,module,exports){
module.exports={_partials:{"partials/nav":require("/home/jljb1990/Trabajo/backbone/backbone-boilerplate/app/views/partials/nav.html")},_filters:{},getPartial:function(t){if(t in this._partials)return this._partials[t];if(this._parent)return this._parent.getPartial(t);throw new Error("Missing partial "+t)},getFilter:function(t){if(t in this._filters)return this._filters[t];if(this._parent)return this._parent.getFilter(t);throw new Error("Missing filter "+t)},registerPartial:function(t,r){this._partials[t]=r,r._parent=this},registerFilter:function(t,r){this._filters[t]=r},render:function(t){function r(t){return Object.prototype.toString.call(t).slice(8,-1).toLowerCase()}function e(t){return"string"!==r(t)?t:t.replace(/["&'<>`]/g,function(t){return"&#"+t.charCodeAt(0)+";"})}try{return function(t,r){return r.getPartial("partials/nav").render(null)+'\n<section class="content">\n'+r.getPartial("content").render(null)+"</section>\n"}(0,this)}catch(t){return console.error(t),"<pre>"+e(t+t.stack)+"</pre>"}}};
},{"/home/jljb1990/Trabajo/backbone/backbone-boilerplate/app/views/partials/nav.html":9}],7:[function(require,module,exports){
module.exports={_partials:{"layouts/page":require("/home/jljb1990/Trabajo/backbone/backbone-boilerplate/app/views/layouts/page.html")},_filters:{},getPartial:function(t){if(t in this._partials)return this._partials[t];if(this._parent)return this._parent.getPartial(t);throw new Error("Missing partial "+t)},getFilter:function(t){if(t in this._filters)return this._filters[t];if(this._parent)return this._parent.getFilter(t);throw new Error("Missing filter "+t)},registerPartial:function(t,r){this._partials[t]=r,r._parent=this},registerFilter:function(t,r){this._filters[t]=r},render:function(t){function r(t){return Object.prototype.toString.call(t).slice(8,-1).toLowerCase()}function e(t){return"string"!==r(t)?t:t.replace(/["&'<>`]/g,function(t){return"&#"+t.charCodeAt(0)+";"})}try{return function(t,r){return""+(r.getPartial("layouts/page").registerPartial("content",{render:function(r){return t=r||t,"  <h2>a modern web application architecture</h2>\n"},data:t,_filters:{},_partials:{}}),r.getPartial("layouts/page").render(t))}(t,this)}catch(t){return console.error(t),"<pre>"+e(t+t.stack)+"</pre>"}}};

},{"/home/jljb1990/Trabajo/backbone/backbone-boilerplate/app/views/layouts/page.html":6}],8:[function(require,module,exports){
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{default:e}}Object.defineProperty(exports,"__esModule",{value:!0});var _component=require("../../component"),_component2=_interopRequireDefault(_component),_home=require("./home.html"),_home2=_interopRequireDefault(_home);require("../components/sample-component"),exports.default=_component2.default.extend({template:_home2.default,initialize:function(){this.template.registerPartial("nav",require("../partials/nav.html"))}});

},{"../../component":1,"../components/sample-component":5,"../partials/nav.html":9,"./home.html":7}],9:[function(require,module,exports){
module.exports={_partials:{},_filters:{},getPartial:function(t){if(t in this._partials)return this._partials[t];if(this._parent)return this._parent.getPartial(t);throw new Error("Missing partial "+t)},getFilter:function(t){if(t in this._filters)return this._filters[t];if(this._parent)return this._parent.getFilter(t);throw new Error("Missing filter "+t)},registerPartial:function(t,r){this._partials[t]=r,r._parent=this},registerFilter:function(t,r){this._filters[t]=r},render:function(t){function r(t){return Object.prototype.toString.call(t).slice(8,-1).toLowerCase()}function e(t){return"string"!==r(t)?t:t.replace(/["&'<>`]/g,function(t){return"&#"+t.charCodeAt(0)+";"})}try{return'<nav>\n  <div class="header"></div>\n\n  <h1>Backbone Boilerplate</h1>\n\n  <hr>\n\n  <a href="#getting-started">Getting started</a>\n  <a href="#components">Components</a>\n  <a href="#components">Deployment</a>\n</nav>\n'}catch(t){return console.error(t),"<pre>"+e(t+t.stack)+"</pre>"}}};
